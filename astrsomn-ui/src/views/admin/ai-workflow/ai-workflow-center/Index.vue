<template>
  <AstrsomnDashboardWrapper>
    <div class="workflow-center-page">
      ...
      <a-card class="module-card" :bordered="false" title="模块导航">
        <a-row :gutter="[16, 16]">
          <a-col :xs="24" :sm="12" :xl="8" v-for="item in moduleCards" :key="item.title">
            <a-card hoverable class="jump-card" @click="goTo(item.routeName)">
