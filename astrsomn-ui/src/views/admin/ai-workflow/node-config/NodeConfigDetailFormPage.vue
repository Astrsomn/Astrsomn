<template>
  <AstrsomnPageShell title="节点配置详情" description="查看节点配置详情。" empty-text="">
    <div class="form-page">
      ...
      <a-form class="detail-form" layout="vertical" :model="form">
        <a-row :gutter="16">
          ...
          <a-col :xs="24" :md="12"><a-form-item label="flowDefinitionId"><a-input v-model:value="form.flowDefinitionId" disabled /></a-form-item></a-col>
          <a-col :xs="24" :md="12"><a-form-item label="nodeId"><a-input v-model:value="form.nodeId" disabled /></a-form-item></a-col>
          <a-col :xs="24" :md="12"><a-form-item label="nodeType"><a-input v-model:value="form.nodeType" disabled /></a-form-item></a-col>
          <a-col :xs="24" :md="12"><a-form-item label="enabled"><a-input v-model:value="form.enabled" disabled /></a-form-item></a-col>
