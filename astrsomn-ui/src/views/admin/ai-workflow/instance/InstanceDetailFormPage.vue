<template>
  <AstrsomnPageShell title="流程实例详情" description="查看流程实例详情。" empty-text="">
    <div class="form-page">
      ...
      <a-form class="detail-form" layout="vertical" :model="form">
        <a-row :gutter="16">
          ...
          <a-col :xs="24" :md="12"><a-form-item label="deploymentId"><a-input v-model:value="form.deploymentId" disabled /></a-form-item></a-col>
          <a-col :xs="24" :md="12"><a-form-item label="businessKey"><a-input v-model:value="form.businessKey" disabled /></a-form-item></a-col>
          <a-col :xs="24" :md="12"><a-form-item label="executionStatus"><a-input v-model:value="form.executionStatus" disabled /></a-form-item></a-col>
          <a-col :xs="24" :md="12"><a-form-item label="currentNodeId"><a-input v-model:value="form.currentNodeId" disabled /></a-form-item></a-col>
          <a-col :xs="24" :md="12"><a-form-item label="createTime"><a-input v-model:value="form.createTime" disabled /></a-form-item></a-col>
          <a-col :xs="24" :md="12"><a-form-item label="updateTime"><a-input v-model:value="form.updateTime" disabled /></a-form-item></a-col>
