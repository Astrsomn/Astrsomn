<template>
  <AstrsomnPageShell title="人工任务详情" description="查看人工任务详情。" empty-text="">
    <div class="form-page">
      ...
      <a-form class="detail-form" layout="vertical" :model="form">
        <a-row :gutter="16">
          ...
          <a-col :xs="24" :md="12"><a-form-item label="instanceId"><a-input v-model:value="form.instanceId" disabled /></a-form-item></a-col>
          <a-col :xs="24" :md="12"><a-form-item label="nodeId"><a-input v-model:value="form.nodeId" disabled /></a-form-item></a-col>
          <a-col :xs="24" :md="12"><a-form-item label="taskStatus"><a-input v-model:value="form.taskStatus" disabled /></a-form-item></a-col>
          <a-col :xs="24" :md="12"><a-form-item label="assignee"><a-input v-model:value="form.assignee" disabled /></a-form-item></a-col>
