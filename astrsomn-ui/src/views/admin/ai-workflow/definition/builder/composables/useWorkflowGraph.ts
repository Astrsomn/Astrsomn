...
import {addEdge, type Connection, type Edge, MarkerType} from '@vue-flow/core'
...
export function useWorkflowGraph() {
    ...
    const updateSelectedNode = (payload: {
        label?: string;
        description?: string;
    ...
    const loadGraph = (graphJson?: string) => {
        ...
        const rawCanvasConfig = (parsed.meta?.canvasConfig || {}) as Partial<CanvasConfig> & {
            edgeStyleDefault?: unknown
        }
