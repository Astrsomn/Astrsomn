<template>
  ...
  >
    ...
    <template #header-title>{{ t.unloadDialog.title }}</template>
    <template #header-subtitle>{{ extensionLabel || t.unloadDialog.extension }}</template>
    <template #header-actions>
      <a-button @click="emit('cancel')">{{ t.unloadDialog.cancel }}</a-button>
      <a-button
        :disabled="okDisabled"
        :loading="confirming"
        danger
