      ...
      <template v-else>
        <div v-if="models.length" class="model-section__grid">
          ...
          <div class="add-card" @click="handleCreate">
            ...
            <span class="add-text">{{ t.model.create }}</span>
          </div>
...
.model-section__grid > *:nth-child(1) { animation-delay: 0ms; }
.model-section__grid > *:nth-child(2) { animation-delay: 40ms; }
.model-section__grid > *:nth-child(3) { animation-delay: 80ms; }
.model-section__grid > *:nth-child(4) { animation-delay: 120ms; }
.model-section__grid > *:nth-child(5) { animation-delay: 160ms; }
.model-section__grid > *:nth-child(6) { animation-delay: 200ms; }
.model-section__grid > *:nth-child(7) { animation-delay: 240ms; }
.model-section__grid > *:nth-child(8) { animation-delay: 280ms; }
.model-section__grid > *:nth-child(9) { animation-delay: 320ms; }
.model-section__grid > *:nth-child(10) { animation-delay: 360ms; }
.model-section__grid > *:nth-child(n+11) { animation-delay: 400ms; }
