...
.agent-grid > *:nth-child(1) { animation-delay: 0ms; }
.agent-grid > *:nth-child(2) { animation-delay: 40ms; }
.agent-grid > *:nth-child(3) { animation-delay: 80ms; }
.agent-grid > *:nth-child(4) { animation-delay: 120ms; }
.agent-grid > *:nth-child(5) { animation-delay: 160ms; }
.agent-grid > *:nth-child(6) { animation-delay: 200ms; }
.agent-grid > *:nth-child(7) { animation-delay: 240ms; }
.agent-grid > *:nth-child(8) { animation-delay: 280ms; }
.agent-grid > *:nth-child(9) { animation-delay: 320ms; }
.agent-grid > *:nth-child(10) { animation-delay: 360ms; }
.agent-grid > *:nth-child(n+11) { animation-delay: 400ms; }
