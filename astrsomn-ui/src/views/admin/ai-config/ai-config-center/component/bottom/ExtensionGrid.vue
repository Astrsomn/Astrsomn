  ...
  <div class="extension-grid">
    ...
    <div class="extension-card" @click="navigateTo('/admin/ai-safety/templates')" @mouseenter="showDescription['templates'] = true" @mouseleave="showDescription['templates'] = false">
      ...
      <div class="card-content">
        ...
        <span v-if="showDescription['templates']" class="card-description">管理模板文件</span>
      </div>
    </div>
  </div>
</template>
...
const toggleDescription = (key: string) => {
  showDescription.value[key] = !showDescription.value[key]
}
</script>
...
.extension-icon--indigo {
  color: #6366f1;
}

.extension-icon--violet {
  color: #8b5cf6;
}
