...
.instance-provider-select { flex: 0 0 auto; min-width: 140px; max-width: 200px; }
.provider-search-pill { flex: 1; min-width: 0; }
.provider-search-pill :deep(.toolbar-search-pill) { width: 100%; }
.model-type-tabs :deep(.ant-tabs-nav) { margin-bottom: 0; }
...
.model-select-radio { width: 16px; height: 16px; border: 1px solid #cbd5e1; border-radius: 50%; display: inline-flex; align-items: center; justify-content: center; flex-shrink: 0; }
.model-select-radio .dot { width: 8px; height: 8px; border-radius: 50%; background: transparent; }
.model-select-card.is-active .model-select-radio { border-color: #3b82f6; }
.model-select-card.is-active .model-select-radio .dot { background: #3b82f6; }
.inst-provider-avatar-cell { display: inline-flex; align-items: center; justify-content: center; vertical-align: middle; width: 24px; height: 24px; flex-shrink: 0; }
.inst-provider-avatar-cell :deep(svg) { width: 22px; height: 22px; display: block; }
.inst-provider-avatar-cell--empty { color: #cbd5e1; background: #f8fafc; border-radius: 6px; }
.endpoint-main { min-width: 0; display: flex; flex-direction: column; gap: 4px; }
.endpoint-name { font-size: 13px; font-weight: 600; color: #1e293b; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
.endpoint-meta { display: inline-flex; align-items: center; gap: 6px; }
.inst-model-type-icon { width: 22px; height: 22px; border-radius: 6px; display: flex; align-items: center; justify-content: center; font-size: 12px; color: #fff; flex-shrink: 0; }
.inst-model-type-icon.chat { background: linear-gradient(135deg, #0061ff, #60efff); }
.inst-model-type-icon.embedding { background: linear-gradient(135deg, #7c4dff, #f94dff); }
