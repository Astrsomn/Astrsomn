  ...
  >
    ...
    <div class="card-content">
      ...
      <h3 :title="record.promptTitle" class="title">
        {{ record.promptTitle || t.card.unnamed }}
      </h3>
      ...
      >
        ...
        <code class="code">{{ record.promptKey || t.card.autoGeneratedKey }}</code>
    ...
    <div class="card-footer-action">
      <div class="user-meta">
        ...
        <span class="meta-info">{{ record.createUser || t.card.systemUser }}</span>
