<template>
  <div class="node-connector">
    <div :class="{ 'has-model': model }" class="model-card">
      <div class="card-header">
        <div class="header-left">
          ...
          <div class="header-info">
            <span class="card-label">{{ t.modelCard.label }}</span>
      ...
      <template v-else>
        <div class="card-placeholder">{{ readonly ? t.modelCard.autoAssociated : t.modelCard.selectModel }}</div>
      </template>
      <div v-if="!readonly" class="card-icon">
        <DoubleRightOutlined/>
      </div>
      <div v-if="!readonly" class="card-overlay">
        <button class="overlay-btn" :title="t.modelCard.selectModelBtn" @click.stop="emit('select')">
