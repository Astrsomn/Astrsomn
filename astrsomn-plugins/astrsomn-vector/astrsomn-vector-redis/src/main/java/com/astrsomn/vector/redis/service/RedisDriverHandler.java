...
public final class RedisDriverHandler extends AbstractVecDriver {
    ...
    public VecSource bindSource(AiVecSourceEntity source) {
        return new RedisVecSourceHandler(source);
    }
    ...
    public AiVecDriverEntity getDriverEntity() {
        ...
        return AiVecDriverEntity.builder()
                .driverName(AiVecDriverEnum.Provider.REDIS.getDesc())
                .provider(AiVecDriverEnum.Provider.REDIS.getCode())
