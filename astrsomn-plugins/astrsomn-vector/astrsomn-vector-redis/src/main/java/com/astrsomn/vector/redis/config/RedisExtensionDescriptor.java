package com.astrsomn.vector.redis.config;
...
public class RedisExtensionDescriptor extends AstroExtensionDescriptor {

    private static final String DEFAULT_NAME = AiVecDriverEnum.Provider.REDIS.getDesc();
    private static final String DEFAULT_VERSION = "0.2.0-SNAPSHOT";
    private static final String AVATAR_BASE64 =
            loadClasspathUtf8(RedisExtensionDescriptor.class, "/avatar/redis-avatar.base64");
    ...
    private static Properties loadExtensionProperties() {
        try (InputStream inputStream = RedisExtensionDescriptor.class.getResourceAsStream("/extension-redis.properties")) {
            if (inputStream == null) {
            ...
            throw new UncheckedIOException("Failed to load /extension-redis.properties", e);
        }
    }

    @Override
    public String getExtensionKey() {
        return AiVecDriverEnum.Provider.REDIS.getCode();
    }
    ...
    public String getDescription() {
        return "Redis vector database integration (LangChain4j).";
    }
