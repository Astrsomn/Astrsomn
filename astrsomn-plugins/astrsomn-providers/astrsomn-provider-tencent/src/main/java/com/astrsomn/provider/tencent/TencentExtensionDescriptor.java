...
public class TencentExtensionDescriptor extends AstroExtensionDescriptor {

    private static final String DEFAULT_NAME = "Tencent Model Provider";
    ...
    private static final String AVATAR_BASE64 =
            loadClasspathUtf8(TencentExtensionDescriptor.class, "/avatar/tencent-avatar.base64");
    ...
    private static Properties loadExtensionProperties() {
        try (InputStream inputStream = TencentExtensionDescriptor.class.getResourceAsStream("/extension-tencent.properties")) {
            if (inputStream == null) {
            ...
            throw new UncheckedIOException("Failed to load /extension-tencent.properties", e);
        }
    }

    @Override
    public String getExtensionKey() {
        return AiModelEnum.ProviderEnum.TENCENT.getCode();
    }
    ...
    public String getDescription() {
        return "Tencent model provider — Hunyuan series chat models via OpenAI-compatible API.";
    }
