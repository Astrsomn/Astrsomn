...
public class TencentModelApiClient {
    private static final String DEFAULT_BASE_URL = "https://api.lkeap.cloud.tencent.com/v1";
    private final String baseUrl;
    private final HttpClient httpClient;

    public TencentModelApiClient() { this(DEFAULT_BASE_URL); }
    public TencentModelApiClient(String baseUrl) {
