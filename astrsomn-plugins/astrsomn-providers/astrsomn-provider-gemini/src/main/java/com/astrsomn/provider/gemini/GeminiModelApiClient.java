...
public class GeminiModelApiClient {
    private static final String DEFAULT_BASE_URL = "https://generativelanguage.googleapis.com";
    private final String baseUrl;
    private final HttpClient httpClient;

    public GeminiModelApiClient() { this(DEFAULT_BASE_URL); }
    public GeminiModelApiClient(String baseUrl) {
    ...
    public List<ProviderModelDTO> listModels(String apiKey, String apiSecret) {
        ...
        try {
            ...
            for (Map<String, Object> item : modelsList) {
                ...
                dto.setModelName((String) item.get("displayName"));
                if (dto.getModelName() == null) dto.setModelName(modelId);
