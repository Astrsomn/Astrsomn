...
public class DeepSeekModelApiClient {
    private static final String DEFAULT_BASE_URL = "https://api.deepseek.com";
    private final String baseUrl;
    private final HttpClient httpClient;

    public DeepSeekModelApiClient() { this(DEFAULT_BASE_URL); }
    public DeepSeekModelApiClient(String baseUrl) {
    ...
    private static String inferModelType(String modelId) {
        ...
        if (id.contains("dall-e") || (id.contains("davinci") && id.contains("image"))) return "image";
        return "chat";
    }
}
