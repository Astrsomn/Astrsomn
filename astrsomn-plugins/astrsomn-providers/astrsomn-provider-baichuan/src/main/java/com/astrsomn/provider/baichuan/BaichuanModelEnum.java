...
@Getter
public enum BaichuanModelEnum {

    BAICHUAN4("Baichuan4", "Baichuan4", AiModelEnum.ModelTypeEnum.CHAT_MODEL.getCode(),
            List.of(
    ...
    BAICHUAN3_TURBO("Baichuan3-Turbo", "Baichuan3 Turbo", AiModelEnum.ModelTypeEnum.CHAT_MODEL.getCode(),
            List.of(
                    AiModelParamEnum.ChatCapabilitiesEnum.STREAMING,
                    AiModelParamEnum.ChatCapabilitiesEnum.TOOLS
            ),
    ...
    BAICHUAN3_TURBO_128K("Baichuan3-Turbo-128k", "Baichuan3 Turbo 128K", AiModelEnum.ModelTypeEnum.CHAT_MODEL.getCode(),
            List.of(
                    AiModelParamEnum.ChatCapabilitiesEnum.STREAMING,
                    AiModelParamEnum.ChatCapabilitiesEnum.TOOLS
            ),
    ...
    BAICHUAN2_TURBO("Baichuan2-Turbo", "Baichuan2 Turbo", AiModelEnum.ModelTypeEnum.CHAT_MODEL.getCode(),
            List.of(
                    AiModelParamEnum.ChatCapabilitiesEnum.STREAMING,
                    AiModelParamEnum.ChatCapabilitiesEnum.TOOLS
            ),
    ...
    BAICHUAN2_53B("Baichuan2-53B", "Baichuan2 53B", AiModelEnum.ModelTypeEnum.CHAT_MODEL.getCode(),
            List.of(
                    AiModelParamEnum.ChatCapabilitiesEnum.STREAMING,
                    AiModelParamEnum.ChatCapabilitiesEnum.TOOLS
            ),
    ...
    BaichuanModelEnum(String modelName, String description, String modelType,
    ...
    public static boolean isParamAvailable(String modelKey, String targetParamCode) {
        ...
        for (BaichuanModelEnum model : values()) {
