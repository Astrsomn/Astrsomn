...
public class BaichuanModelApiClient {
    private static final String DEFAULT_BASE_URL = "https://api.baichuan-ai.com/v1";
    private final String baseUrl;
    private final HttpClient httpClient;

    public BaichuanModelApiClient() { this(DEFAULT_BASE_URL); }
    public BaichuanModelApiClient(String baseUrl) {
    ...
    public List<ProviderModelDTO> listModels(String apiKey, String apiSecret) {
        ...
        try {
            ...
            for (Map<String, Object> item : dataList) {
                ...
                if (displayName == null) displayName = (String) item.get("model_show_name");
