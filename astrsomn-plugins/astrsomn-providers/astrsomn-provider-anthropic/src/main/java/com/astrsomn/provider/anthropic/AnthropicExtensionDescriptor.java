...
public class AnthropicExtensionDescriptor extends AstroExtensionDescriptor {

    private static final String DEFAULT_NAME = "Anthropic Model Provider";
    ...
    private static final String AVATAR_BASE64 =
            loadClasspathUtf8(AnthropicExtensionDescriptor.class, "/avatar/anthropic-avatar.base64");
    ...
    private static Properties loadExtensionProperties() {
        try (InputStream inputStream = AnthropicExtensionDescriptor.class.getResourceAsStream("/extension-anthropic.properties")) {
            if (inputStream == null) {
            ...
            throw new UncheckedIOException("Failed to load /extension-anthropic.properties", e);
        }
    }

    @Override
    public String getExtensionKey() {
        return AiModelEnum.ProviderEnum.ANTHROPIC.getCode();
    }
    ...
    public String getDescription() {
        return "Anthropic model provider — Claude series chat models via Anthropic API.";
    }
