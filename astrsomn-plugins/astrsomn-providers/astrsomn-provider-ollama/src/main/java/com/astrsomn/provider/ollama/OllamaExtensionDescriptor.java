...
public class OllamaExtensionDescriptor extends AstroExtensionDescriptor {

    private static final String DEFAULT_NAME = "Ollama Model Provider";
    ...
    private static final String AVATAR_BASE64 =
            loadClasspathUtf8(OllamaExtensionDescriptor.class, "/avatar/ollama-avatar.base64");
    ...
    private static Properties loadExtensionProperties() {
        try (InputStream inputStream = OllamaExtensionDescriptor.class.getResourceAsStream("/extension-ollama.properties")) {
            if (inputStream == null) {
            ...
            throw new UncheckedIOException("Failed to load /extension-ollama.properties", e);
        }
    }

    @Override
    public String getExtensionKey() {
        return AiModelEnum.ProviderEnum.LOCAL.getCode();
    }
    ...
    public String getDescription() {
        return "Ollama model provider — local LLM models via OpenAI-compatible API.";
    }
