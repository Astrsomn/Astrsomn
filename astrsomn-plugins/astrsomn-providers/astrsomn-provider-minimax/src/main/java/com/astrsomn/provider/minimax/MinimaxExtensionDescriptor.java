...
public class MinimaxExtensionDescriptor extends AstroExtensionDescriptor {

    private static final String DEFAULT_NAME = "MiniMax Model Provider";
    ...
    private static final String AVATAR_BASE64 =
            loadClasspathUtf8(MinimaxExtensionDescriptor.class, "/avatar/minimax-avatar.base64");
    ...
    private static Properties loadExtensionProperties() {
        try (InputStream inputStream = MinimaxExtensionDescriptor.class.getResourceAsStream("/extension-minimax.properties")) {
            if (inputStream == null) {
            ...
            throw new UncheckedIOException("Failed to load /extension-minimax.properties", e);
        }
    }

    @Override
    public String getExtensionKey() {
        return AiModelEnum.ProviderEnum.MINIMAX.getCode();
    }
    ...
    public String getDescription() {
        return "MiniMax model provider — chat and embedding models via OpenAI-compatible API.";
    }
