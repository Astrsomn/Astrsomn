...
public class VolcengineModelApiClient {
    private static final String DEFAULT_BASE_URL = "https://ark.cn-beijing.volces.com";
    private final String baseUrl;
    private final HttpClient httpClient;

    public VolcengineModelApiClient() { this(DEFAULT_BASE_URL); }
    public VolcengineModelApiClient(String baseUrl) {
    ...
    public List<ProviderModelDTO> listModels(String apiKey, String apiSecret) {
        ...
        try {
            HttpRequest request = HttpRequest.newBuilder()
                    .uri(URI.create(baseUrl + "/api/v3/models"))
            ...
            // Volcengine Ark API returns models in various formats
