...
public class XiaomiExtensionDescriptor extends AstroExtensionDescriptor {

    private static final String DEFAULT_NAME = "Xiaomi Model Provider";
    ...
    private static final String AVATAR_BASE64 =
            loadClasspathUtf8(XiaomiExtensionDescriptor.class, "/avatar/xiaomi-avatar.base64");
    ...
    private static Properties loadExtensionProperties() {
        try (InputStream inputStream = XiaomiExtensionDescriptor.class.getResourceAsStream("/extension-xiaomi.properties")) {
            if (inputStream == null) {
            ...
            throw new UncheckedIOException("Failed to load /extension-xiaomi.properties", e);
        }
    }

    @Override
    public String getExtensionKey() {
        return AiModelEnum.ProviderEnum.XIAOMI.getCode();
    }
    ...
    public String getDescription() {
        return "Xiaomi model provider — MiMo series chat models via OpenAI-compatible API.";
    }
