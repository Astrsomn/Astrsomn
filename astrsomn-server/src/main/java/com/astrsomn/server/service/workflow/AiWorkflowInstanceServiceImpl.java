...
public class AiWorkflowInstanceServiceImpl extends ServiceImpl<AstFlowInstanceMapper, AstFlowInstanceEntity> implements AiWorkflowInstanceService {
    ...
    public BaseResponse<AstFlowInstanceResponseDTO> detail(Long id) {
        ...
        AstFlowInstanceResponseDTO detail = baseMapper.detail(id);
        if (detail == null) {
            throw new BusinessException(ErrorEnum.NOT_FOUND, "流程实例不存在");
        }
