...
public class AiWorkflowBizIdempotentServiceImpl extends ServiceImpl<AstFlowBizIdempotentMapper, AstFlowBizIdempotentEntity> implements AiWorkflowBizIdempotentService {
    ...
    public BaseResponse<AstFlowBizIdempotentResponseDTO> detail(Long id) {
        ...
        AstFlowBizIdempotentResponseDTO detail = baseMapper.detail(id);
