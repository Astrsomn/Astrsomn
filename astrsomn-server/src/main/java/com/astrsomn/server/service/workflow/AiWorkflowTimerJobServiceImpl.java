...
public class AiWorkflowTimerJobServiceImpl extends ServiceImpl<AstFlowTimerJobMapper, AstFlowTimerJobEntity> implements AiWorkflowTimerJobService {
    ...
    public BaseResponse<AstFlowTimerJobResponseDTO> detail(Long id) {
        ...
        AstFlowTimerJobResponseDTO detail = baseMapper.detail(id);
