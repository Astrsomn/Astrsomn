...
public class AiWorkflowDeploymentServiceImpl extends ServiceImpl<AstFlowDeploymentMapper, AstFlowDeploymentEntity> implements AiWorkflowDeploymentService {
    ...
    public BaseResponse<AstFlowDeploymentResponseDTO> detail(Long id) {
        ...
        AstFlowDeploymentResponseDTO detail = baseMapper.detail(id);
