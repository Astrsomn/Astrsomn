...
public class AiWorkflowHumanTaskServiceImpl extends ServiceImpl<AstFlowHumanTaskMapper, AstFlowHumanTaskEntity> implements AiWorkflowHumanTaskService {
    ...
    public BaseResponse<AstFlowHumanTaskResponseDTO> detail(Long id) {
        ...
        AstFlowHumanTaskResponseDTO detail = baseMapper.detail(id);
        if (detail == null) {
            throw new BusinessException(ErrorEnum.NOT_FOUND, "人工任务不存在");
        }
